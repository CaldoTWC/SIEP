...
<body>
    ...
    <div class="form-container">
        <div class="page-header">
            <h1>📋 Formulario de Registro de Vacantes</h1>
            <p>Complete todos los campos requeridos para publicar una nueva vacante</p>
        </div>
        ...
        <form action="/SIEP/public/index.php?action=postVacancy" method="POST" id="vacancyForm">
            ...
            <div class="readonly-notice">
                ℹ️ Los siguientes campos están prellenados con la información de su empresa registrada y no pueden ser
                modificados.
            </div>

            <div class="form-group">
                <label>1. Nombre de la empresa</label>
                <input type="text" value="<?php echo htmlspecialchars($company_data['company_name'] ?? ''); ?>"
                    disabled>
            </div>

            <div class="form-group">
                <label>2. Nombre comercial</label>
                <input type="text" value="<?php echo htmlspecialchars($company_data['commercial_name'] ?? ''); ?>"
                    disabled>
            </div>

            <div class="form-group">
                <label>3. Giro de la empresa</label>
                <input type="text" value="<?php echo htmlspecialchars($company_data['business_area'] ?? ''); ?>"
                    disabled>
            </div>

            <div class="form-group">
                <label>4. Tipo de empresa o dependencia</label>
                <input type="text" value="<?php echo htmlspecialchars($company_data['company_type'] ?? ''); ?>"
                    disabled>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text"
                    value="<?php echo htmlspecialchars($company_data['website'] ?? 'No especificado'); ?>" disabled>
            </div>

            <div class="form-group">
                <label>7. Cantidad de empleados</label>
                <input type="text" value="<?php echo htmlspecialchars($company_data['employee_count'] ?? ''); ?>"
                    disabled>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text"
                    value="<?php echo htmlspecialchars($company_data['first_name'] . ' ' . $company_data['last_name_p'] . ' ' . $company_data['last_name_m']); ?>"
                    disabled>
            </div>

            <div class="form-group">
                <label>9. Teléfono de la persona contacto en la empresa</label>
                <input type="text" value="<?php echo htmlspecialchars($company_data['phone_number'] ?? ''); ?>"
                    disabled>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text"
                    value="<?php echo htmlspecialchars($company_data['student_programs'] ?? 'No especificado'); ?>"
                    disabled>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="vacancy_names" rows="3"
                    placeholder="Si tiene múltiples vacantes, describa cada una"></textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="key_information" rows="4"
                    placeholder="Describa los aspectos más importantes de la vacante que quiera destacar"></textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="required_knowledge" rows="5" required
                    placeholder="Ej: JavaScript, React, Node.js, MySQL, Git, etc."></textarea>
            ...
            <div class="form-group">
                ...
                <textarea name="required_competencies" rows="4"
                    placeholder="Ej: Trabajo en equipo, comunicación efectiva, resolución de problemas, etc."></textarea>
            </div>
     ...
     ======================================== -->
            ...
            <div class="form-group">
                ...
                <textarea name="activities_list" rows="10" required placeholder="Ejemplo:
...
- Documentar código y realizar pruebas unitarias" style="font-family: monospace; line-height: 1.8;"></textarea>
                <p class="help-text">Escriba cada actividad en una línea nueva. Puede usar guiones (-) o números para
                    listarlas.</p>
            </div>

            <div class="form-group">
                <label>Descripción general de actividades (opcional)</label>
                <textarea name="activity_details" rows="4"
                    placeholder="Contexto adicional sobre las actividades, ambiente de trabajo, etc."></textarea>
            ...
            <div id="presencial-section" class="conditional-section">
                ...
                <div class="form-group">
                    <label>Domicilio donde el o la estudiante desarrollará las actividades <span
                            class="required">*</span></label>
                    <textarea name="work_location_address" rows="3" id="work_address"
            ...
            <div class="privacy-box">
                ...
                <p style="font-size: 13px; line-height: 1.6; margin-bottom: 15px;">
                    Los datos personales recabados serán protegidos en términos de los artículos 1, 9, 11, fracción VI,
                    16 113, fracción I, 117, fracción V, 186, fracción IV de la Ley Federal de Transparencia y Acceso a
                    la Información Pública, 68, fracciones II y VI, 116 y 206, fracción IV de la Ley General de
                    Transparencia y Acceso a la Información Pública; 1, 16, 17, 18, 19, 21, 22, 23, 24, 25 y 66 fracción
                    I, 67, 69, 70, fracción I y 163 fracciones III, IV y X de la Ley General de Protección de Datos
