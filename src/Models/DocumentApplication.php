...
class DocumentApplication {
    ...
    // ========================================================================
    // MÉTODOS PARA HUB MODERNO DE CARTAS
    // ========================================================================

    /**
     * Obtener cartas por status (genérico para el hub)
     */
    public function getLettersByStatus($status) {
        $sql = "SELECT da.*, 
                       sp.boleta, u.first_name, u.last_name_p, u.last_name_m,
                       sp.career, da.credits_percentage as percentage_progress,
                       da.target_company_name as company_name,
    ...
    /**
     * Obtener carta aprobada por student_user_id
     */
    public function getApprovedLetterByStudentId($student_user_id) {
        $sql = "SELECT * FROM document_applications 
    ...
    public function getStudentDataForLetter($application_id) {
        $sql = "SELECT u.*, sp.*, 
                       ...
                       da.recipient_position, da.requires_hours, 
                       da.letter_template_type,
                       da.id as application_id,
                       da.credits_percentage as percentage_progress
                FROM document_applications da
